...
| `docker.instructions.md` | `**/Dockerfile*`, `.dockerignore`, `docker-compose*.yml` | Multi-arch builds, stage structure, caching, provenance, hardening, compose volume taxonomy |
