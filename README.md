...
**Triggers**: Pushes to `main`, pull requests targeting `main`, and manual dispatch.
...
- `deploy-all.yml` — Builds and publishes the application image, NuGet packages,
  and Helm umbrella chart
