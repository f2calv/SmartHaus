...
- **Public-repo hygiene.** SmartHaus is a **public** repository. Per the cross-repo rules, nothing generated by Spec Kit (constitution, specs, plans, tasks, issues) may reference non-public repositories, their classes, or their internals. Specs describe SmartHaus only.
